...
test('TemplateValidator', async (t) => {
  ...
  await t.test('schema management', async (t) => {
  ...
  await t.test('validation', async (t) => {
    ...
    await t.test('format validation', async (t) => {
    ...
    await t.test('constraint validation', async (t) => {
